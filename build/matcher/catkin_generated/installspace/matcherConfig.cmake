...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'matcher' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ryan/GitHub_WorkSpace/dataGeneration/install/${idir}'.  Ask the maintainer 'ryan <ryan@todo.todo>' to fix it.")
    endif()
