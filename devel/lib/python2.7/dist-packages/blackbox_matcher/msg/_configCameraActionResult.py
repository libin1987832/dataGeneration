...
"""autogenerated by genpy from blackbox_matcher/configCameraActionResult.msg. Do not edit."""
import sys
...
class configCameraActionResult(genpy.Message):
  _md5sum = "f6ded34aa746c8855596ae9da3f50c65"
  _type = "blackbox_matcher/configCameraActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','blackbox_matcher/configCameraResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(configCameraActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = blackbox_matcher.msg.configCameraResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = blackbox_matcher.msg.configCameraResult()
