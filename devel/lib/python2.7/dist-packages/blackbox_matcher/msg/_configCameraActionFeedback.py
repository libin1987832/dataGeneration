...
"""autogenerated by genpy from blackbox_matcher/configCameraActionFeedback.msg. Do not edit."""
import sys
...
class configCameraActionFeedback(genpy.Message):
  _md5sum = "1da5ee34b6e3bd7d50994fc7a6d13fcb"
  _type = "blackbox_matcher/configCameraActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','blackbox_matcher/configCameraFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(configCameraActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = blackbox_matcher.msg.configCameraFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = blackbox_matcher.msg.configCameraFeedback()
