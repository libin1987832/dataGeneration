...
"""autogenerated by genpy from simulator/newSimulationActionResult.msg. Do not edit."""
import sys
...
class newSimulationActionResult(genpy.Message):
  _md5sum = "f6ded34aa746c8855596ae9da3f50c65"
  _type = "simulator/newSimulationActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','simulator/newSimulationResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(newSimulationActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = simulator.msg.newSimulationResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = simulator.msg.newSimulationResult()
