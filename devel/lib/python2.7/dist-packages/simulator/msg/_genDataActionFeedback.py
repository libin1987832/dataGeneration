...
"""autogenerated by genpy from simulator/genDataActionFeedback.msg. Do not edit."""
import sys
...
class genDataActionFeedback(genpy.Message):
  _md5sum = "1da5ee34b6e3bd7d50994fc7a6d13fcb"
  _type = "simulator/genDataActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','simulator/genDataFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(genDataActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = simulator.msg.genDataFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = simulator.msg.genDataFeedback()
