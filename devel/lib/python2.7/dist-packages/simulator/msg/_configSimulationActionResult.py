...
"""autogenerated by genpy from simulator/configSimulationActionResult.msg. Do not edit."""
import sys
...
class configSimulationActionResult(genpy.Message):
  _md5sum = "f6ded34aa746c8855596ae9da3f50c65"
  _type = "simulator/configSimulationActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','simulator/configSimulationResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(configSimulationActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = simulator.msg.configSimulationResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = simulator.msg.configSimulationResult()
