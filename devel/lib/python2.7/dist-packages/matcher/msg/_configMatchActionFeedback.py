...
"""autogenerated by genpy from matcher/configMatchActionFeedback.msg. Do not edit."""
import sys
...
class configMatchActionFeedback(genpy.Message):
  _md5sum = "1da5ee34b6e3bd7d50994fc7a6d13fcb"
  _type = "matcher/configMatchActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','matcher/configMatchFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(configMatchActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = matcher.msg.configMatchFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = matcher.msg.configMatchFeedback()
