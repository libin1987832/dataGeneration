...
"""autogenerated by genpy from matcher/saveMatchesActionFeedback.msg. Do not edit."""
import sys
...
class saveMatchesActionFeedback(genpy.Message):
  _md5sum = "1da5ee34b6e3bd7d50994fc7a6d13fcb"
  _type = "matcher/saveMatchesActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','matcher/saveMatchesFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(saveMatchesActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = matcher.msg.saveMatchesFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = matcher.msg.saveMatchesFeedback()
