...
"""autogenerated by genpy from matcher/saveMatchesActionResult.msg. Do not edit."""
import sys
...
class saveMatchesActionResult(genpy.Message):
  _md5sum = "f6ded34aa746c8855596ae9da3f50c65"
  _type = "matcher/saveMatchesActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','matcher/saveMatchesResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(saveMatchesActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = matcher.msg.saveMatchesResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = matcher.msg.saveMatchesResult()
