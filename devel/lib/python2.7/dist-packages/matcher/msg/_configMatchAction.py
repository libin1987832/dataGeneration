...
"""autogenerated by genpy from matcher/configMatchAction.msg. Do not edit."""
import sys
...
class configMatchAction(genpy.Message):
  _md5sum = "d04152ef1423bb500e17391a31debc1b"
  _type = "matcher/configMatchAction"
...
"""
  ...
  _slot_types = ['matcher/configMatchActionGoal','matcher/configMatchActionResult','matcher/configMatchActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(configMatchAction, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = matcher.msg.configMatchActionGoal()
      if self.action_result is None:
        self.action_result = matcher.msg.configMatchActionResult()
      if self.action_feedback is None:
        self.action_feedback = matcher.msg.configMatchActionFeedback()
    else:
      self.action_goal = matcher.msg.configMatchActionGoal()
      self.action_result = matcher.msg.configMatchActionResult()
      self.action_feedback = matcher.msg.configMatchActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self.action_goal.goal.TopicName.data
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self.action_goal.goal.CameraDirectory.data
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.action_goal.goal.TopicName.data = str[start:end].decode('utf-8')
      else:
        self.action_goal.goal.TopicName.data = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.action_goal.goal.CameraDirectory.data = str[start:end].decode('utf-8')
      else:
        self.action_goal.goal.CameraDirectory.data = str[start:end]
      _x = self
      start = end
      end += 12
