...
"""autogenerated by genpy from matcher/saveMatchesAction.msg. Do not edit."""
import sys
...
class saveMatchesAction(genpy.Message):
  _md5sum = "24aa4335de73c42714fb6b45df751129"
  _type = "matcher/saveMatchesAction"
...
"""
  ...
  _slot_types = ['matcher/saveMatchesActionGoal','matcher/saveMatchesActionResult','matcher/saveMatchesActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(saveMatchesAction, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = matcher.msg.saveMatchesActionGoal()
      if self.action_result is None:
        self.action_result = matcher.msg.saveMatchesActionResult()
      if self.action_feedback is None:
        self.action_feedback = matcher.msg.saveMatchesActionFeedback()
    else:
      self.action_goal = matcher.msg.saveMatchesActionGoal()
      self.action_result = matcher.msg.saveMatchesActionResult()
      self.action_feedback = matcher.msg.saveMatchesActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self.action_goal.goal.saveDirectory.data
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.action_goal.goal.saveDirectory.data = str[start:end].decode('utf-8')
      else:
        self.action_goal.goal.saveDirectory.data = str[start:end]
      _x = self
      start = end
      end += 12
