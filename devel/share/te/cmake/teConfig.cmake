...
if(NOT "/home/ryan/GitHub_WorkSpace/dataGeneration/src/te/include " STREQUAL " ")
  set(te_INCLUDE_DIRS "")
  set(_include_dirs "/home/ryan/GitHub_WorkSpace/dataGeneration/src/te/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'te' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ryan/GitHub_WorkSpace/dataGeneration/src/te/${idir}'.  Ask the maintainer 'ryan <ryan@todo.todo>' to fix it.")
    endif()
