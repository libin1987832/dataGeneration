...
(cl:defmethod Relative-val ((m <RelativeFrame>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader shared_files-msg:Relative-val is deprecated.  Use shared_files-msg:Relative instead.")
  (Relative m))
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <RelativeFrame>) ostream)
  ...
  (cl:let ((__ros_arr_len (cl:length (cl:slot-value msg 'Relative))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) __ros_arr_len) ostream))
  (cl:map cl:nil #'(cl:lambda (ele) (roslisp-msg-protocol:serialize ele ostream))
   (cl:slot-value msg 'Relative))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <RelativeFrame>) istream)
  ...
  (cl:setf (cl:slot-value msg 'Relative) (cl:make-array __ros_arr_len))
  (cl:let ((vals (cl:slot-value msg 'Relative)))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<RelativeFrame>)))
  ...
  "bac4de3f205f6a8002a0371e02d737fd")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'RelativeFrame)))
  "Returns md5sum for a message object of type 'RelativeFrame"
  "bac4de3f205f6a8002a0371e02d737fd")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<RelativeFrame>)))
  ...
  (cl:format cl:nil "shared_files/RelativePoint[] Relative~%std_msgs/Int32 FrameNumber~%~%================================================================================~%MSG: shared_files/RelativePoint~%geometry_msgs/Point coord~%std_msgs/Int32 identification~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: std_msgs/Int32~%int32 data~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'RelativeFrame)))
  "Returns full string definition for message of type 'RelativeFrame"
  (cl:format cl:nil "shared_files/RelativePoint[] Relative~%std_msgs/Int32 FrameNumber~%~%================================================================================~%MSG: shared_files/RelativePoint~%geometry_msgs/Point coord~%std_msgs/Int32 identification~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: std_msgs/Int32~%int32 data~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <RelativeFrame>))
  (cl:+ 0
     4 (cl:reduce #'cl:+ (cl:slot-value msg 'Relative) :key #'(cl:lambda (ele) (cl:declare (cl:ignorable ele)) (cl:+ (roslisp-msg-protocol:serialization-length ele))))
